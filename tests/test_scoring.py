...
from dna.scoring import Signal, calibrated_display_score, contribution, display_score, similarity
...
class TestScoring(__import__("unittest").TestCase):
    ...
    def test_single_book_signal_is_not_presented_as_established(self): self.assertLessEqual(calibrated_display_score(2,2,1),55)
